  ...
  return (
    <div className="register-container">
      ...
      <div className="form-section">
        ...
        <form onSubmit={handleSubmit} className="register-form">
          ...
          <div className="profile-upload-container">
            ...
            <span className="file-name">
              {formData.profilePic
                ...
                : "No file chosen (File size should be 800kb or below)"}
            </span>
            {imageUrl && (
              <img
                src={imageUrl}
          ...
          <div className="signup-checkbox">
            ...
            />
            <span>
              I agree with SavorSpace&apos;s Terms, Services, Privacy and Policy
            </span>
          </div>
      ...
      <div className="register-hero">
        <img
          src="src/images/signup-hero.png"
          alt="Savor the flavor, Share the love"
        />
        <h3>
          Savor the flavor, <br />
          Share the love
      ...
      {showFileSizeError && (
        <div ref={errorRef} className="file-size-error">
